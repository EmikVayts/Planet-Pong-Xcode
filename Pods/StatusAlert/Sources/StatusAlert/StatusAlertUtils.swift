...
@objc extension StatusAlert {
    ...
    public final class Appearance: NSObject {
        ...
        @objc public var titleFont: UIFont = UIFont(name: "Myriad Pro Semibold.ttf", size: 23) ?? UIFont.systemFont(ofSize: 23, weight: FontWeightRegular)
        
        /// - Note: Do not change to save system look
        @objc public var messageFont: UIFont = UIFont(name: "Myriad Pro Semibold.ttf", size: 16) ?? UIFont.systemFont(ofSize: 16, weight: FontWeightRegular)
    ...
    public final class SizesAndDistances: NSObject {
        ...
        @objc public var initialScale: CGFloat = 2
        @objc public var cornerRadius: CGFloat = 10

        @objc public var topOffset: CGFloat = 32
        @objc public var bottomOffset: CGFloat = 32

        @objc public var imageWidth: CGFloat = 180
        @objc public var alertWidth: CGFloat = 250
        ...
        @objc public var imageBottomSpace: CGFloat = 10
